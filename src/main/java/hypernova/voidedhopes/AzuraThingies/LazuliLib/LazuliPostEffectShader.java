...
public class LazuliPostEffectShader implements AutoCloseable {
    ...
    public final List<PostEffectPass> passes = Lists.<PostEffectPass>newArrayList();
    ...
    public LazuliPostEffectShader(TextureManager textureManager, ResourceManager resourceManager, Framebuffer framebuffer, Identifier id) throws IOException, JsonSyntaxException {
